...
class WPSAttack:
    ...
    def bruteforce_pin(self, bssid: str) -> Optional[str]:
        known_pins = [
            ...
            '99999999', '01234567', '12345678', '87654321'
        ]
...
========================================
            SHS - Revived
              -@vzexg-2 
========================================
I abandoned this last year btw.
"""
        Write.Print(banner + "\n", Colors.red_to_purple, interval=0.0001)
        Write.Print("--------------------\nUser: shsm\nPass: shsm00\n\n", Colors.red_to_purple, interval=0.0001)
    def _auth(self):
...
def main():
    try:
        if os.geteuid() != 0:
            ...
            Write.Print("Please run with: sudo python3 script.py\n", Colors.red_to_purple, interval=0.0001)
            sys.exit(1)
    ...
    if not show_disclaimer():
        Write.Print("\nU must agree to the disclaimer to use this shit, u are lucky i aint putting ip logger brotato\n", Colors.red_to_purple, interval=0.0001)
        sys.exit(1)
